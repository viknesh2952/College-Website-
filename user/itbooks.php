...
<body >
	...
	<br><br>
	<form>
	<a href="syllabus/syllabusit.pdf" download><input class="MyButton" type="button" value="BTech IT Syllabus"></a>
	...
	<a href="https://drive.google.com/file/d/1kYeckzB9gI2jTuJtTmI4IWw1guZ9eVWI/view?usp=drivesdk"><input class="MyButton" type="button"
	value="Engineering Physics-2"></a>
...
"><input class="MyButton" type="button" value="Object Oriented Programming"></a>
	...
	<a href="https://drive.google.com/file/d/1mz5BTWjOmeaAkrrWExiQENjt6Kpd2T1o/view?usp=drivesdk"><input class="MyButton" type="button" value="Web Technology"></a>
	<a href="https://drive.google.com/file/d/19OeO_yorC79Sx-9XA3Uz37HbeQtAN7Qr/view?usp=drivesdk"><input class="MyButton" type="button" value="Computer Graphics"></a>
	<a href="https://drive.google.com/file/d/1gWMReopBr7Gvn1rx3wwnUSqgAgGE2ow-/view?usp=drivesdk"><input class="MyButton" type="button" value="Graph Theory"></a>
	<a href="https://drive.google.com/file/d/1f66z4S3IEjpnQshaDqQnkLt4sUVHC64b/view?usp=drivesdk"><input class="MyButton" type="button" value="Information Storage"></a>
	<a href="https://drive.google.com/file/d/1yD8f7bW-krAo_rfc7fVbhXQFbUmCbAoV/view?usp=drivesdk"><input class="MyButton" type="button" value="PHP"></a>
	<a href="https://drive.google.com/file/d/1ez_z7G5GEsHvA2bRw3V4W5HWT8lDZBtM/view?usp=drivesdk"><input class="MyButton" type="button" value="Mobile Communication"></a>
	</form>
