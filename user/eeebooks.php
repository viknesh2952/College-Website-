...
<body >
	...
	<br><br>
	<form>
	<a href="syllabus/syllabuseee.pdf" download><input class="MyButton" type="button" value="B.E EEE Syllabus"></a>
	...
	<a href="https://drive.google.com/file/d/1f0Aj43hKg4gNr6TVxL4XGkquu1W0E3-B/view?usp=drivesdk"><input class="MyButton" type="button" value="Operational Amplifier and Linear IC"></a>
	<a href="https://drive.google.com/file/d/1F6M1vssdPv8mZcEtaiHMFezV4R_fs9Hy/view?usp=drivesdk"><input class="MyButton" type="button" value="Digital Design"></a>
	<a href="https://drive.google.com/file/d/1JrtJVw9oKe2fAgzW-IPknJcQ0TrMP9nC/view?usp=drivesdk"><input class="MyButton" type="button" value="Electric Machinery Fundamental"></a>
	<a href="https://drive.google.com/file/d/1P5HjBcrD3vxaGvJ8KC3FGxHpEadRxnf9/view?usp=drivesdk"><input class="MyButton" type="button" value="Power PLant"></a>
	<a href="https://drive.google.com/file/d/1ujcfH91JBU0CKfNPKzSF0IXszECz_d3g/view?usp=drivesdk"><input class="MyButton" type="button" value="Modern Power"></a>
	</form>
