...
<body id="it">
	...
	<h2>Our Faculties</h2>
<pre>
Dr. S. Selvi, ME, PhD, MISTE,MIE,MIETE			Associate Prof.& HOD i.c.
Mr. J. Ganesh, ME, MISTE				Asst.Prof
Mrs. R. Chithra Devi, M.Tech, (PhD), MISTE		Asst.Prof		
Mrs. N. Subbulakshmi, M.Tech,(Ph D), MISTE		Asst.Prof
Mr. A. Suthan, M.Tech, MISTE,MIE,MACM			Asst.Prof
Ms. M. Kamala Malar, ME, MISTE				Asst.Prof
Mrs. A. Thomas Mary Sheeba, M.Tech, MISTE		Asst.Prof
Mrs. M. Jancyrani Malli, M.Tech, MISTE			Asst.Prof
Ms. M. Muthamil Selvi, M.Tech, MISTE			Asst.Prof
Mrs. A. Muthulakshmi, M.Tech ,MISTE			Asst.Prof
Mr. N.K.Sethu,ME,MISTE					Asst.Prof
Ms. R.Krishnaveni Jeenath, M.Tech, MISTE		Asst.Prof
</pre>
