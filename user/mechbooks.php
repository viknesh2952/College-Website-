...
<body >
	...
	<br><br>
	<form>
	<a href="syllabus/syllabusmech.pdf" download><input class="MyButton" type="button" value="B.E MECH Syllabus"></a>
	...
	<a href="https://drive.google.com/file/d/1vJbbKTcxhIOFIy08DBjutq_XcrhtjBjP/view?usp=drivesdk"><input class="MyButton" type="button" value="Design of Mechanical Element"></a>
	<a href="https://drive.google.com/file/d/1ljaO9jdB-6HGxpqrgHf2JY1bfTBd_0NF/view?usp=drivesdk"><input class="MyButton" type="button" value="KOM"></a>
	<a href="https://drive.google.com/file/d/1-RrVfJ4vlhJmnHsX6Zr1h9DQdlgeN914/view?usp=drivesdk"><input class="MyButton" type="button" value="Thermodynamic Engineering"></a>
	<a href="https://drive.google.com/file/d/1-Xvjr8QGFElMBD6lLodrupwgFJofL5EB/view?usp=drivesdk"><input class="MyButton" type="button" value="Fluid Mechanics"></a>
	</form>
